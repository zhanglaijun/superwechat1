...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
    ...
    private void deleteGroupFromApp(String ts5){
                ...
                .execute(new OkHttpUtils2.OnCompleteListener<String>() {
                    ...
                    public void onSuccess(String s) {
                        ...
                        if(result!=null&&result.isRetMsg()){
                            new DownloadMemberMaoTask(getApplicationContext(),groupId).getContacts();
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    progressDialog.dismiss();
                                    setResult(RESULT_OK);
                    ...
                    public void onError(String error) {
                        progressDialog.dismiss();
                        Toast.makeText(GroupDetailsActivity.this,st2+error,Toast.LENGTH_SHORT).show();
                    }
                });
    }
	@Override
...
//				holder.textView.setText(username);
    ...
    private void setmUpdateMemberListener(){
